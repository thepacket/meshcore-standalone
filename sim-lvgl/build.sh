...
cc $CFLAGS \
  ...
  examples/companion_radio/ui-lvgl/lv_peer.c \
  examples/companion_radio/ui-lvgl/lv_tools.c \
  examples/companion_radio/ui-lvgl/lv_stats.c \
  examples/companion_radio/ui-lvgl/lv_discover.c \
  examples/companion_radio/ui-lvgl/lv_contacts.c \
